...
window.dom = {
	...
	jqPlayerSubtitlesMenu: $( "#ctrl .menu.subtitles .menu-activate" ),
	jqPlayerSubtitlesTooltip: $( "#ctrl .menu.subtitles .menu-activate span:nth-child(2)" ),
	jqPlayerSubtitlesBtn: $( "#ctrl .menu.subtitles .menu-activate .slidebutton input" ),
	jqPlayerSubtitlesList: $( "#ctrl .menu.subtitles .menu-list" ),
